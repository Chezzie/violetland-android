...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        List<ResolveInfo> ri = mPackageManager.queryIntentServices(serviceIntent, 0);
    ...
    void consume(Purchase itemInfo) throws IabException {
        ...
        try {
            ...
            int response = mService.consumePurchase(3, mPackageName, token);
            if (response == BILLING_RESPONSE_RESULT_OK) {
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException, IabException {
    	...
    	try {
	        ...
	        do {
	            ...
	            Bundle ownedItems = mService.getPurchases(3, mPackageName,
    		...
    		throw new IabException(IABHELPER_UNKNOWN_ERROR, "Unexpected exception while refreshing inventory.", ex);
    	}
    }
    ...
    int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus)
        ...
        Bundle skuDetails = mService.getSkuDetails(3, mPackageName,
                itemType, querySkus);
